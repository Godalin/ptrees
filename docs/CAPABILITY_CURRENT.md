...
Scope: **25 selected definitions/helpers/endpoints**. This is a migration signature baseline, not an audit of every public theorem or a proof that these capabilities are mathematically minimal. No theorem statements or proofs were changed to obtain it.

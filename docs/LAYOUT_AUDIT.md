...
Coq's `.PTree.theory.d` supplies 3411 direct local Require edges covering 219 ordinary modules out of 220 maintained modules. External libraries are excluded. Transitive clients include re-export paths; an import does not prove use of each declaration.
...
Root closure reaches 116 modules; 103 lie outside it. Unreachable modules can still be meaningful regressions or independent measure theorems. All remain built by Dune; no deletion follows from this classification.
...
- `PTree.Prob.Backend.Common.FinSupp` (0 direct local clients)
- `PTree.Prob.Backend.Common.RealSubTypes` (1 direct local clients)
- `PTree.Prob.Backend.Enum.FreeOmega.Coupling` (3 direct local clients)
- `PTree.Prob.Backend.Enum.FreeOmega.MeasureAudit` (0 direct local clients)
- `PTree.Prob.Backend.Enum.FreeOmega.NativeTransport` (0 direct local clients)
- `PTree.Prob.Backend.Enum.FreeOmega.UpperContinuity` (3 direct local clients)
- `PTree.Prob.Backend.Enum.FreeOmega.UpperCoupling` (5 direct local clients)
- `PTree.Prob.Backend.Enum.FreeOmega.UpperExpectation` (8 direct local clients)
- `PTree.Prob.Backend.Enum.FreeOmega.UpperObservation` (2 direct local clients)
- `PTree.Prob.Backend.Enum.FreeOmega.UpperQuotient` (2 direct local clients)
- `PTree.Prob.Backend.Enum.FreeOmega.UpperRelational` (2 direct local clients)
- `PTree.Prob.Backend.MathComp.Coupling` (1 direct local clients)
- `PTree.Prob.Backend.SubEnum.FreeOmega.CodedJoint` (1 direct local clients)
- `PTree.Prob.Backend.SubEnum.FreeOmega.EquivalenceJoint` (1 direct local clients)
- `PTree.Prob.FreeOmega.JointExtension` (2 direct local clients)
...
- `PTree.Examples.BernoulliFactory.BernoulliFactoryComposition` — retained root
- `PTree.Examples.BernoulliFactory.BernoulliFactoryProbability` — retained root
- `PTree.Examples.BernoulliFactory.OperationalRationalBernoulli` — retained root
- `PTree.Examples.BernoulliFactory.OperationalRealBernoulliMathComp` — retained root
- `PTree.Examples.MixedHeadProtocol` — retained root
- `PTree.Prob.Backend.Common.FinSupp` — built leaf
- `PTree.Prob.Backend.Enum.FreeOmega.MeasureAudit` — built leaf
- `PTree.Prob.Backend.Enum.FreeOmega.NativeTransport` — built leaf
...
- Direct imports: `PTree.Eq.Internal.FreeOmega.KernelCompletion`, `PTree.Eq.Internal.FreeOmega.KernelCongruence`, `PTree.Eq.PrimitiveStableHitting`, `PTree.Prob.Backend.Enum.Disintegration`, `PTree.Prob.Backend.SubEnum.FreeOmega.Disintegration`, `PTree.Prob.Backend.SubEnum.Measure`, `PTree.Prob.FreeOmega.Approximation`, `PTree.Prob.FreeOmega.Definition`, `PTree.Prob.FreeOmega.Measure`, `PTree.Prob.FreeOmega.Observation`, `PTree.Prob.FreeOmega.Quotient`, `PTree.Prob.FreeOmega.StructuralMeasure`, `PTree.Prob.FreeOmega.SupportLift`, `PTree.Prob.Interface.AE`, `PTree.Prob.Interface.Coupling`, `PTree.Prob.Interface.Measure`, `PTree.Prob.Interface.Mixed`, `PTree.Prob.Interface.Omega`, `PTree.Prob.Interface.Subprobability`.
...
- In retained-root closure: no.
- Direct imports: `PTree.Core.PTreeDefinition`, `PTree.Prob.Interface.AE`, `PTree.Prob.Interface.Coupling`, `PTree.Prob.Interface.Measure`, `PTree.Prob.Interface.Mixed`, `PTree.Prob.Interface.Omega`, `PTree.Prob.Interface.Subprobability`.
...
- In retained-root closure: no.
- Direct imports: `PTree.Core.PTreeDefinition`, `PTree.Eq.Internal.FiniteInternal`, `PTree.Eq.Internal.FiniteInternalHitting`, `PTree.Eq.PStrong`, `PTree.Eq.PTreeKernel`, `PTree.Eq.PrimitiveStableHitting`, `PTree.Eq.UnifiedFrontier`, `PTree.Prob.Interface.AE`, `PTree.Prob.Interface.Coupling`, `PTree.Prob.Interface.Measure`, `PTree.Prob.Interface.Mixed`, `PTree.Prob.Interface.Omega`, `PTree.Prob.Interface.SemanticCoupling`, `PTree.Prob.Interface.Subprobability`.
...
- In retained-root closure: no.
- Direct imports: `PTree.Core.PTreeDefinition`, `PTree.Eq.Internal.FiniteInternal`, `PTree.Prob.Interface.AE`, `PTree.Prob.Interface.Coupling`, `PTree.Prob.Interface.Measure`, `PTree.Prob.Interface.Mixed`, `PTree.Prob.Interface.Omega`, `PTree.Prob.Interface.Subprobability`.
...
- In retained-root closure: no.
- Direct imports: `PTree.Eq.Internal.FreeOmega.KernelContinuity`, `PTree.Eq.PrimitiveStableHitting`, `PTree.Prob.FreeOmega.Approximation`, `PTree.Prob.FreeOmega.Definition`, `PTree.Prob.FreeOmega.Measure`, `PTree.Prob.FreeOmega.Observation`, `PTree.Prob.FreeOmega.Quotient`, `PTree.Prob.FreeOmega.StructuralMeasure`, `PTree.Prob.FreeOmega.SupportLift`, `PTree.Prob.Interface.AE`, `PTree.Prob.Interface.Coupling`, `PTree.Prob.Interface.Measure`, `PTree.Prob.Interface.Mixed`, `PTree.Prob.Interface.Omega`, `PTree.Prob.Interface.Subprobability`.
...
- In retained-root closure: no.
- Direct imports: `PTree.Core.PTreeDefinition`, `PTree.Eq.Internal.FiniteInternal`, `PTree.Eq.PStrong`, `PTree.Eq.PTreeKernel`, `PTree.Eq.PrimitiveStableHitting`, `PTree.Eq.UnifiedFrontier`, `PTree.Prob.FreeOmega.Approximation`, `PTree.Prob.FreeOmega.Definition`, `PTree.Prob.FreeOmega.Measure`, `PTree.Prob.FreeOmega.Observation`, `PTree.Prob.FreeOmega.Quotient`, `PTree.Prob.FreeOmega.StructuralMeasure`, `PTree.Prob.FreeOmega.SupportLift`, `PTree.Prob.Interface.AE`, `PTree.Prob.Interface.Coupling`, `PTree.Prob.Interface.Measure`, `PTree.Prob.Interface.Mixed`, `PTree.Prob.Interface.Omega`, `PTree.Prob.Interface.Subprobability`.
...
- In retained-root closure: no.
- Direct imports: `PTree.Core.PTreeDefinition`, `PTree.Eq.Internal.FiniteInternal`, `PTree.Eq.Internal.FreeOmega.FiniteInternal`, `PTree.Eq.Internal.FreeOmega.FiniteInternalJoint`, `PTree.Eq.Internal.FreeOmega.KernelContinuity`, `PTree.Eq.PEutt`, `PTree.Eq.PStrong`, `PTree.Eq.PTreeKernel`, `PTree.Eq.PrimitiveStableHitting`, `PTree.Eq.UnifiedFrontier`, `PTree.Prob.FreeOmega.Approximation`, `PTree.Prob.FreeOmega.Coupling`, `PTree.Prob.FreeOmega.Definition`, `PTree.Prob.FreeOmega.Measure`, `PTree.Prob.FreeOmega.Observation`, `PTree.Prob.FreeOmega.Quotient`, `PTree.Prob.FreeOmega.StructuralMeasure`, `PTree.Prob.FreeOmega.SupportLift`, `PTree.Prob.Interface.AE`, `PTree.Prob.Interface.Coupling`, `PTree.Prob.Interface.Measure`, `PTree.Prob.Interface.Mixed`, `PTree.Prob.Interface.Omega`, `PTree.Prob.Interface.SemanticCoupling`, `PTree.Prob.Interface.Subprobability`.
...
- In retained-root closure: no.
- Direct imports: `PTree.Core.PTreeDefinition`, `PTree.Eq.Internal.FiniteInternalPlan`, `PTree.Eq.Internal.FreeOmega.CostedKernel`, `PTree.Eq.Internal.FreeOmega.FiniteInternalCostedProjection`, `PTree.Eq.Internal.FreeOmega.FiniteInternalNative`, `PTree.Eq.Internal.FreeOmega.FiniteInternalRound`, `PTree.Eq.PEutt`, `PTree.Eq.PTreeKernel`, `PTree.Eq.PrimitiveStableHitting`, `PTree.Eq.UnifiedFrontier`, `PTree.Prob.FreeOmega.Approximation`, `PTree.Prob.FreeOmega.Definition`, `PTree.Prob.FreeOmega.Measure`, `PTree.Prob.FreeOmega.Native`, `PTree.Prob.FreeOmega.Observation`, `PTree.Prob.FreeOmega.Quotient`, `PTree.Prob.FreeOmega.StructuralMeasure`, `PTree.Prob.FreeOmega.SupportLift`, `PTree.Prob.Interface.AE`, `PTree.Prob.Interface.Coupling`, `PTree.Prob.Interface.Measure`, `PTree.Prob.Interface.Mixed`, `PTree.Prob.Interface.Omega`, `PTree.Prob.Interface.Subprobability`.
...
- In retained-root closure: no.
- Direct imports: `PTree.Core.PTreeDefinition`, `PTree.Eq.Internal.FiniteInternal`, `PTree.Eq.Internal.FiniteInternalPlan`, `PTree.Eq.Internal.FreeOmega.FiniteInternalJoint`, `PTree.Prob.FreeOmega.Approximation`, `PTree.Prob.FreeOmega.Definition`, `PTree.Prob.FreeOmega.Measure`, `PTree.Prob.FreeOmega.Native`, `PTree.Prob.FreeOmega.Observation`, `PTree.Prob.FreeOmega.Quotient`, `PTree.Prob.FreeOmega.StructuralMeasure`, `PTree.Prob.FreeOmega.SupportLift`, `PTree.Prob.Interface.AE`, `PTree.Prob.Interface.Coupling`, `PTree.Prob.Interface.Measure`, `PTree.Prob.Interface.Mixed`, `PTree.Prob.Interface.Omega`, `PTree.Prob.Interface.Subprobability`.
- Direct clients: `PTree.Eq.Internal.FreeOmega.FiniteInternalCostedCoinduction`, `PTree.Eq.Internal.FreeOmega.FiniteInternalCostedProjection`, `PTree.Eq.Internal.FreeOmega.FiniteInternalJointRows`, `PTree.Eq.Internal.FreeOmega.FiniteInternalNativeJoint`, `PTree.Eq.Internal.FreeOmega.FiniteInternalRound`, `PTree.Eq.Internal.FreeOmega.FiniteInternalRoundCoupling`, `PTree.Regression.Backend.NativeReflection`, `PTree.Regression.Infrastructure.CostedRounds`, `PTree.Regression.Infrastructure.FiniteInternalNative`, `PTree.Regression.Infrastructure.FiniteInternalPlan`, `PTree.Regression.Infrastructure.FiniteInternalRound`, `PTree.Regression.Infrastructure.NativeRecovery`.
- All transitive clients: `PTree.Eq.Internal.FreeOmega.FiniteInternalCostedCoinduction`, `PTree.Eq.Internal.FreeOmega.FiniteInternalCostedProjection`, `PTree.Eq.Internal.FreeOmega.FiniteInternalJointRows`, `PTree.Eq.Internal.FreeOmega.FiniteInternalNativeJoint`, `PTree.Eq.Internal.FreeOmega.FiniteInternalRound`, `PTree.Eq.Internal.FreeOmega.FiniteInternalRoundCoupling`, `PTree.Regression.Backend.NativeReflection`, `PTree.Regression.Infrastructure.CostedRounds`, `PTree.Regression.Infrastructure.FiniteInternalNative`, `PTree.Regression.Infrastructure.FiniteInternalPlan`, `PTree.Regression.Infrastructure.FiniteInternalRound`, `PTree.Regression.Infrastructure.NativeRecovery`.
...
- In retained-root closure: no.
- Direct imports: `PTree.Core.PTreeDefinition`, `PTree.Eq.Internal.FiniteInternalPlan`, `PTree.Eq.Internal.FreeOmega.FiniteInternalNative`, `PTree.Eq.Internal.FreeOmega.FiniteInternalRoundCoupling`, `PTree.Eq.PStrong`, `PTree.Prob.FreeOmega.Approximation`, `PTree.Prob.FreeOmega.Definition`, `PTree.Prob.FreeOmega.JointExtension`, `PTree.Prob.FreeOmega.Measure`, `PTree.Prob.FreeOmega.Native`, `PTree.Prob.FreeOmega.Observation`, `PTree.Prob.FreeOmega.Quotient`, `PTree.Prob.FreeOmega.StructuralMeasure`, `PTree.Prob.FreeOmega.SupportLift`, `PTree.Prob.Interface.AE`, `PTree.Prob.Interface.Coupling`, `PTree.Prob.Interface.Measure`, `PTree.Prob.Interface.Mixed`, `PTree.Prob.Interface.Omega`, `PTree.Prob.Interface.SemanticCoupling`, `PTree.Prob.Interface.Subprobability`.
...
- In retained-root closure: no.
- Direct imports: `PTree.Eq.Internal.FreeOmega.KernelCompletion`, `PTree.Eq.PrimitiveStableHitting`, `PTree.Prob.FreeOmega.Approximation`, `PTree.Prob.FreeOmega.Coupling`, `PTree.Prob.FreeOmega.Definition`, `PTree.Prob.FreeOmega.Measure`, `PTree.Prob.FreeOmega.Observation`, `PTree.Prob.FreeOmega.Quotient`, `PTree.Prob.FreeOmega.StructuralMeasure`, `PTree.Prob.FreeOmega.SupportLift`, `PTree.Prob.Interface.AE`, `PTree.Prob.Interface.Coupling`, `PTree.Prob.Interface.Measure`, `PTree.Prob.Interface.Mixed`, `PTree.Prob.Interface.Omega`, `PTree.Prob.Interface.Subprobability`.

...
(** Compatibility projection of the generic finite-cylinder semantics to
    ...
    node measures satisfy [enumQ_subprob].  New probability-facing clients
    should use [ProbabilisticTraceSubEnumQ].  A certificate contains a query
    together
...
Notation "'Prₜ[' t '|' pattern ']' '=' p" :=
  (enumQ_finite_interaction_probability pattern t p)

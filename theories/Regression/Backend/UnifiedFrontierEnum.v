...
(** Native Enum samples live below heads containing recursive trees.  Use
    FreeOmega for those heads: sharing the monomorphic Enum interface at
...
Definition unified_reg_split_heads :
    MF (stable_head regE Enum bool) :=
  FOSample reg_fair_split (fun b => FORet (FHRet b)).

Lemma reg_split_program_unified_frontier :
  @frontier_certificate regE Enum MF Enum_SemanticMeasure FI
...
Proof.
  ...
  apply (@UFProb regE Enum MF Enum_SemanticMeasure FI

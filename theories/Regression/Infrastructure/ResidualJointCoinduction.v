...
Proof.
  ...
  { intro t. destruct (classic (retry_region t)) as [[b Hb]|Hnot].
    ...
    - exists (FORet t). split.
      + exact (@FIStop E SubEnumQ MF FI FreeOmegaMixedMeasure A t).
...
Example eventful_retry_discarded_bits :
  @peutt retry_event SubEnumQ (FreeOmega SubEnumQ)
    (FreeOmegaObservableSemanticMeasure (NI := SubEnumQ_SemanticMeasure) (NO := SubEnumQ_SemanticOmega))
    FreeOmegaObservableSemanticMeasureCoreLaws FreeOmegaMixedMeasure
    FreeOmegaObservableSemanticOmega bool bool eq
    (retry_with_noise subenumQ_fair retry_visible_continuation true)
    (retry_with_noise subenumQ_fair retry_visible_continuation false).
...
Example always_failing_retry_discarded_bits :
  @peutt retry_event SubEnumQ (FreeOmega SubEnumQ)
    ...
    FreeOmegaObservableSemanticMeasureCoreLaws FreeOmegaMixedMeasure
    FreeOmegaObservableSemanticOmega bool bool eq
    (retry_with_noise (subenumQ_ret false) retry_visible_continuation true)
    (retry_with_noise (subenumQ_ret false) retry_visible_continuation false).
Proof. apply retry_discarded_bits_peutt. Qed.

...
Require Import PTree.Prob.Backend.EnumQ.FreeOmega.UpperExpectation PTree.Prob.Backend.EnumQ.FreeOmega.UpperCoupling PTree.Prob.Backend.EnumQ.FreeOmega.UpperObservation.

Set Implicit Arguments.
Unset Strict Implicit.
Unset Printing Implicit Defensive.
Import GRing.Theory Num.Theory Order.Theory PTree.Prob.Backend.EnumQ.Representation.EnumQ.
...
Proof.
  ...
  eapply enumQ_lift_extended_expect; [exact Hmu|].
  intros x y Hxy. exact (Hk x y Hxy f g Hf Hg Hfg).
Qed.

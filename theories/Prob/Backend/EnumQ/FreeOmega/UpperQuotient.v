...
Require Import PTree.Prob.Backend.EnumQ.FreeOmega.UpperExpectation PTree.Prob.Backend.EnumQ.FreeOmega.UpperCoupling PTree.Prob.Backend.EnumQ.FreeOmega.UpperContinuity PTree.Prob.Backend.EnumQ.FreeOmega.UpperRelational.

Set Implicit Arguments.
Unset Strict Implicit.
Unset Printing Implicit Defensive.
Import GRing.Theory Num.Theory Order.Theory.
Import PTree.Prob.Backend.EnumQ.Representation.EnumQ.
...
Proof.
  ...
  rewrite enumQ_extended_expect_bind; last by intros [a b]; apply free_omega_extended_upper_nonnegative.
...
Proof.
  ...
  - split; intros f g Hf Hg Hfg; cbn [free_omega_extended_upper];
      rewrite enumQ_extended_expect_zero; exact: lexx.

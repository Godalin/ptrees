...
Require Import PTree.Prob.Backend.SubEnumQ.FreeOmega.UpperExpectation PTree.Prob.Backend.SubEnumQ.FreeOmega.UpperCoupling PTree.Prob.Backend.SubEnumQ.FreeOmega.UpperContinuity PTree.Prob.Backend.SubEnumQ.FreeOmega.UpperRelational.
...
Lemma upper_birel_bind {A B C D} (T : A -> B -> Prop) (U : C -> D -> Prop)
    mu nu (k : A -> FreeOmega SubEnumQ C) (h : B -> FreeOmega SubEnumQ D) :
...
Lemma upper_birel_sample_ae {A B C} (T : A -> B -> Prop) (mu : SubEnumQ C)
    (Good : C -> Prop) (k : C -> FreeOmega SubEnumQ A) (h : C -> FreeOmega SubEnumQ B) :
...
Proof.
  ...
  - split; intros f g Hf Hg Hfg; cbn [free_omega_upper];
      rewrite enumQ_real_expect_zero; exact: lexx.
...
Corollary free_omega_qlift_eq_upper {A} (mu nu : FreeOmega SubEnumQ A) f :
  @free_omega_qlift SubEnumQ SubEnumQ_SemanticMeasure SubEnumQ_SemanticOmega

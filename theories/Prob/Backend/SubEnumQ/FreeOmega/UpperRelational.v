...
Require Import PTree.Prob.Backend.SubEnumQ.FreeOmega.UpperExpectation PTree.Prob.Backend.SubEnumQ.FreeOmega.UpperCoupling PTree.Prob.Backend.SubEnumQ.FreeOmega.UpperObservation.
...
Proof.
  ...
  eapply subenumQ_lift_real_expect; [exact Hmu|].
  intros x y Hxy. exact (Hk x y Hxy f g Hf Hg Hfg).
Qed.

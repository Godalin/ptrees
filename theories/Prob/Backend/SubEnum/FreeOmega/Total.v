...
Require Import PTree.Prob.Backend.Enum.Iteration PTree.Prob.Backend.Enum.Representation.
      ...
      * change (enum_converges (fun n => subenum_raw (outs' n))
        ...
        -- have Hz : forall (T : Type) (mu : Enum T), enum_expect (fun _ => 0) mu = 0.
           { intros T m. induction m as [|[p x] m IH]; [reflexivity|].
             change (PTree.Prob.Backend.Common.RatSubTypes.Qval p * 0 + enum_expect (fun _ => 0) m = 0).

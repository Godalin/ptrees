(** Final DS5a external joint realization for FreeOmega SubEnum.
...
From PTree.Prob.Backend.SubEnum.FreeOmega Require Import Admissibility CouplingSoundness.
...
Section Soundness.
Variable R : realType.
Local Notation qlift := (@free_omega_qlift SubEnum SubEnum_SemanticMeasure SubEnum_SemanticOmega).
...
Theorem free_omega_qlift_eq_sound_via_joint {A} (t u : FreeOmega SubEnum A)
    (Ht : free_omega_admissible R t) (Hu : free_omega_admissible R u) :

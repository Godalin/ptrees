...
Require Import PTree.Prob.Backend.Common.RatSubTypes PTree.Prob.Backend.Enum.Representation PTree.Prob.Backend.Enum.Coupling PTree.Prob.Backend.Enum.IndexedCoupling PTree.Prob.Backend.Enum.Bind PTree.Prob.Backend.Enum.Map.
...
Import Enum PTree.Prob.Backend.Enum.Coupling IndexedCoupling.
Import GRing.Theory.
...
Lemma enum_prune_scale_zero {A} (mu : Enum A) :
  enum_prune (scale_Enum PTree.Prob.Backend.Common.RatSubTypes.nnQ_0 mu) = [::].
Proof.
  elim: mu=> [//=|[p x] mu IH] //=.

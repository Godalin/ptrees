...
From PTree.Prob.Backend Require Import DiscreteMC MeasureIterationEnum.
From PTree.Prob.Interface Require Import TwoLevelMeasure.
From PTree.Prob.Backend Require Import TwoLevelMeasureEnum EnumSupport SemanticCouplingEnum.
From PTree.Prob.FreeOmega Require Import FreeOmegaMeasure.
From PTree.Prob.Backend.FreeOmega Require Import FreeOmegaUpperExpectationSubEnum FreeOmegaUpperCouplingSubEnum FreeOmegaUpperContinuitySubEnum FreeOmegaUpperObservationSubEnum FreeOmegaUpperExpectationEnum FreeOmegaUpperCouplingEnum FreeOmegaUpperContinuityEnum.
...
Proof.
  ...
  apply (rat_monotone_limit_bound
    (values := fun i => RatSubTypes.Qval (acc_mass x (chain i)))).

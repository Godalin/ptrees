...
def report():
    ...
    rows += ["", "## Internal certificate/kernel disposition", "",
             ...
             "public equivalence theory. All members remain in Eq/Internal pending the later adequacy liveness audit. "
    ...
    rows += ["The formal peutt/Interp/facade mainline has no transitive Eq/Internal dependency. "
             ...
             "Gate C will not redesign this auxiliary API; final keep/delete decisions belong to "
             "the FreeOmega adequacy audit.", ""]
